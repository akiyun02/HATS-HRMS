@auth
                            ...
                            <ul role="list" class="-mx-2 space-y-1">
                                ...
                                <li class="mt-4">
                                    ...
                                    <ul role="list" class="space-y-1">
                                        ...
                                        <li>
                                            <a href="{{ route('biometrics.index') }}" class="{{ request()->routeIs('biometrics.*') ? 'bg-slate-50 text-brand-700 dark:bg-slate-800 dark:text-brand-400 border-slate-200 dark:border-slate-700 shadow-sm' : 'text-slate-600 dark:text-slate-400 hover:text-brand-700 dark:hover:text-brand-400 hover:bg-slate-50 dark:hover:bg-slate-800 border-transparent' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold border transition-all duration-200">
                                                <svg class="h-5 w-5 shrink-0 {{ request()->routeIs('biometrics.*') ? 'text-brand-600 dark:text-brand-400' : 'text-slate-400 group-hover:text-brand-600 dark:group-hover:text-brand-400' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
 ...
 class="{{ request()->routeIs('recruitment.*') ? 'bg-slate-50 text-brand-700 dark:bg-slate-800 dark:text-brand-400 border-slate-200 dark:border-slate-700 shadow-sm' : 'text-slate-600 dark:text-slate-400 hover:text-brand-700 dark:hover:text-brand-400 hover:bg-slate-50 dark:hover:bg-slate-800 border-transparent' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold border transition-all duration-200">
                                        ...
                                        <li>
                                            <a href="{{ route('payroll.index') }}" class="{{ request()->routeIs('payroll.*') ? 'bg-slate-50 text-brand-700 dark:bg-slate-800 dark:text-brand-400 border-slate-200 dark:border-slate-700 shadow-sm' : 'text-slate-600 dark:text-slate-400 hover:text-brand-700 dark:hover:text-brand-400 hover:bg-slate-50 dark:hover:bg-slate-800 border-transparent' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold border transition-all duration-200">
                                                <svg class="h-5 w-5 shrink-0 {{ request()->routeIs('payroll.*') ? 'text-brand-600 dark:text-brand-400' : 'text-slate-400 group-hover:text-brand-600 dark:group-hover:text-brand-400' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
